...
export function FundCard({ gift, totals, myContributions, isIdentified, pixConfigured }: FundCardProps) {
  ...
  return (
    <Card className={cn("flex flex-col overflow-hidden", myTotalInCents > 0 && "border-primary/60 ring-1 ring-primary/30")}>
      ...
      <CardContent className="flex flex-1 flex-col gap-2 p-3 sm:gap-3 sm:p-4">
        ...
        <div className="mt-auto flex flex-col gap-2 pt-1">
          ...
          <Button size="sm" variant="soft" onClick={handleContribute} className="w-full">
